...
namespace Bar_rating.Controllers
{
    ...
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(BarRatingDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Text, User ")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text, User ")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
